...
commander
    ...
    .option('--maxLength [maxLength]', 'Transient queue max length')
    .parse(process.argv);
...
options.application.maxLength = commander.maxLength ? parseInt(commander.maxLength, 10) : DEFAULT_MAX_LENGTH;
