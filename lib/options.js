...
const USAGE_EXAMPLES = {
  ...
  'Filter results (pluck key)': `${BIN_NAME} -r username:password@rabbit.mywebsite.com/myvhost -b myExchange:my,routing,keys -f content.data.whatever`,
  'Filter results (search)': 'rabbit-tail -r guest:guest@localhost/ -b scraped-events:test -f content.name=Christian',
